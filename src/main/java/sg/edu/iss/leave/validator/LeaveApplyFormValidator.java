...
public class LeaveApplyFormValidator implements Validator{
	...
	public LeaveApplyFormValidator(HolidayService hs, LeaveRecordService ls, LeaveBalanceService lbs,  HttpSession session) {
		super();
		this.hs = hs;
		this.lrs = ls;
		this.lbs = lbs;
	...
	public boolean supports(Class<?> clazz) {
		...
		return LeaveForm.class.equals(clazz) || Staff.class.equals(clazz);
	}
